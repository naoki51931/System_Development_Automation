...
5. Use a separate ACTIVE-mode plan to set RDS `deletion_protection=false`. Review and apply only that change. The current review plan cannot delete the protected DB.
